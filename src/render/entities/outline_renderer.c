...
outline_renderer create_outline_renderer(camera* cam) {
    ...
    // Create shaders
    shader vertex_shader = create_shader(OUTLINE_VERTEX_SHADER, GL_VERTEX_SHADER);
    shader fragment_shader = create_shader(OUTLINE_FRAGMENT_SHADER, GL_FRAGMENT_SHADER);
